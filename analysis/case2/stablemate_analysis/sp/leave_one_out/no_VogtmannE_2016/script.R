...
Ytrain <- Y[envs != "VogtmannE_2016"]
Xtrain <- X[envs != "VogtmannE_2016" , ]
Ytest <- Y[envs == "VogtmannE_2016"]
Xtest <- X[envs == "VogtmannE_2016" , ]
envs <- envs[envs != "VogtmannE_2016"]
...
save.image('./case2/r_object/sp/leave_one_out/no_VogtmannE_2016.RData')
