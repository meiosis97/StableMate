...
Ytrain <- Y[envs != "ThomasAM_2018b"]
Xtrain <- X[envs != "ThomasAM_2018b" , ]
Ytest <- Y[envs == "ThomasAM_2018b"]
Xtest <- X[envs == "ThomasAM_2018b" , ]
envs <- envs[envs != "ThomasAM_2018b"]
...
save.image('./case2/r_object/sp/leave_one_out/no_ThomasAM_2018b.RData')
