...
Ytrain <- Y[envs != "YuJ_2015"]
Xtrain <- X[envs != "YuJ_2015" , ]
Ytest <- Y[envs == "YuJ_2015"]
Xtest <- X[envs == "YuJ_2015" , ]
envs <- envs[envs != "YuJ_2015"]
...
save.image('./case2/r_object/sp/leave_one_out/no_YuJ_2015.RData')
