...
Ytrain <- Y[envs != "ZellerG_2014"]
Xtrain <- X[envs != "ZellerG_2014" , ]
Ytest <- Y[envs == "ZellerG_2014"]
Xtest <- X[envs == "ZellerG_2014" , ]
envs <- envs[envs != "ZellerG_2014"]
...
save.image('./case2/r_object/sp/leave_one_out/no_ZellerG_2014.RData')
