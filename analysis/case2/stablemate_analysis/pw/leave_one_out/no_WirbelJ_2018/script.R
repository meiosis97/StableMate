...
Ytrain <- Y[envs != "WirbelJ_2018"]
Xtrain <- X[envs != "WirbelJ_2018" , ]
Ytest <- Y[envs == "WirbelJ_2018"]
Xtest <- X[envs == "WirbelJ_2018" , ]
envs <- envs[envs != "WirbelJ_2018"]
...
save.image('./case2/r_object/pw/leave_one_out/no_WirbelJ_2018.RData')
