...
Ytrain <- Y[envs != "YachidaS_2019"]
Xtrain <- X[envs != "YachidaS_2019" , ]
Ytest <- Y[envs == "YachidaS_2019"]
Xtest <- X[envs == "YachidaS_2019" , ]
envs <- envs[envs != "YachidaS_2019"]
...
save.image('./case2/r_object/pw/leave_one_out/no_YachidaS_2019.RData')
