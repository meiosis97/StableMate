...
Ytrain <- Y[envs != "ThomasAM_2018a"]
Xtrain <- X[envs != "ThomasAM_2018a" , ]
Ytest <- Y[envs == "ThomasAM_2018a"]
Xtest <- X[envs == "ThomasAM_2018a" , ]
envs <- envs[envs != "ThomasAM_2018a"]
...
save.image('./case2/r_object/pw/leave_one_out/no_ThomasAM_2018a.RData')
